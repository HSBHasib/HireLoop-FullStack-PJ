              ...
              <Modal.Body>
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full">
                    ...
                    >
                      ...
                      <div className="relative flex items-center w-full">
                        ...
                        >
                          ...
                          <option value="Healthcare" className="bg-[#18181b]">Healthcare</option>
                          <option value="E-Commerce" className="bg-[#18181b]">E-Commerce</option>
                        </select>
                        <FiChevronDown
                    ...
                    <TextField className="w-full flex flex-col relative">
                      ...
                      <div className="relative flex items-center w-full">
                        ...
                        >
                          <option value="1-10" className="bg-[#18181b]">1-10 employees</option>
                          <option value="11-50" className="bg-[#18181b]">11-50 employees</option>
                          <option value="51-200" className="bg-[#18181b]">51-200 employees</option>
                          <option value="201-500" className="bg-[#18181b]">201-500 employees</option>
                          <option value="500+" className="bg-[#18181b]">500+ employees</option>
                        </select>
                        <FiChevronDown
                          className="absolute right-3 text-zinc-500 pointer-events-none"
                          size={16}
                      ...
                      <div className="flex items-center gap-3 border border-zinc-800 bg-zinc-900/40 rounded-xl p-2 h-10 w-full justify-between">
                        <div className="flex items-center gap-2 overflow-hidden max-w-[70%]">
                          ...
                          <span className="text-xs text-zinc-400 truncate">
                            {currentLogoUrl ? "Logo Uploaded" : "PNG, JPG up to 5MB"}
                          </span>
                        </div>
                  ...
                  <Modal.Footer className="pt-4 gap-3 flex justify-end w-full border-t border-zinc-800/50 mt-2">
                    ...
                    >
                      {modalMode === "add" ? "Register Company" : "Save Changes"}
                    </button>
                  </Modal.Footer>
                </Form>
              </Modal.Body>
